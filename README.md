...
```bash
$ # Get the code
$ git clone https://github.com/app-generator/priv-django-dashboard-millenium-pro.git
$ cd priv-django-dashboard-millenium-pro
$
...
---
[Django Millenium PRO](https://appseed.us/admin-dashboards/django-dashboard-millenium-pro) - Provided by **AppSeed** [Web App Generator](https://appseed.us/app-generator).
